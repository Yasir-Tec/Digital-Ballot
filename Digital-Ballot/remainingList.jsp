...
<body>
 ...
 <h1></span> <span class="yellow">UNVOTED VOTER`S LIST</pan></h1>
...
String query2="select * from user1 where voting=0";
...
<% } %>	
 ...
 String query1="select count(voting)from user1 where voting=0";
 ...
 %>
 <h2></span> <span class="#F08080">Total Unvoted Voters = <%=	countrow1 %></pan></h2> 
